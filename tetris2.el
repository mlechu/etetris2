...
(defvar tetris2-mode-map
  (let ((map (make-sparse-keymap 'tetris2-mode-map)))
    ...
    (define-key map "q"		'tetris2-end-game)
    (define-key map "p"		'tetris2-pause-game)

    (define-key map [down]		'tetris2-move-bottom)
    (define-key map [left]	'tetris2-move-left)
    (define-key map [right]	'tetris2-move-right)
    (define-key map [up]	'tetris2-move-down)
    (define-key map "a"	'tetris2-rotate-prev)
    (define-key map "d"	'tetris2-rotate-next)
    (define-key map "s"	'tetris2-rotate-180)
    (define-key map "w"	'tetris2-hold-shape)
    map)
